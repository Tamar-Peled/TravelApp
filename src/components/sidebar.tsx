...
export function Sidebar({
  ...
  return (
    <aside
      className="hidden min-h-0 w-[248px] shrink-0 flex-col overflow-hidden border-r border-white/50 bg-white/50 py-8 shadow-[inset_-1px_0_0_rgba(255,255,255,0.6)] backdrop-blur-xl lg:flex lg:max-h-screen lg:self-stretch"
      aria-label="Primary"
    >
      ...
      <nav
        className="flex shrink-0 flex-col gap-1 px-4 text-[13px]"
        aria-label="Main"
      >
      ...
      <div className="mt-6 flex min-h-0 flex-1 flex-col px-4 pb-2">
        <p className="mb-2 shrink-0 px-3 text-[10px] font-semibold uppercase tracking-[0.14em] text-zinc-400">
          Recent Trips
        </p>
