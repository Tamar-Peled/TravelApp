...
export function Sidebar({
  ...
  return (
    <aside
      className="hidden min-h-0 w-[248px] shrink-0 flex-col overflow-hidden border-r border-white/50 bg-white/50 py-8 shadow-[inset_-1px_0_0_rgba(255,255,255,0.6)] backdrop-blur-xl lg:flex lg:h-full lg:max-h-screen lg:flex-col lg:self-stretch"
      aria-label="Primary"
    >
      ...
      <div className="mt-auto shrink-0 border-t border-gray-100 bg-white p-4">
